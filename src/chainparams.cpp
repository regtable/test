...
static CBlock CreateGenesisBlock(const char* pszTimestamp, const CScript& genesisOutputScript, uint32_t nTimeTx, uint32_t nTimeBlock, uint32_t nNonce, uint32_t nBits, int32_t nVersion, const CAmount& genesisReward)
{
    ...
    txNew.vout[0].scriptPubKey = ParseHex("04678afdb0fe5548271967f1a67130b7105cd6a828e03909a67962e0ea1f61deb649f6bc3f4cef38c4f35504e51ec112de5c384df7ba0b8d578a4c702b6bf11d5f");
    txNew.nTime = nTimeTx;
...
public:
    CMainParams() {
        ...
        consensus.defaultAssumeValid = uint256S("0x9bde1219ab2a738dec00fcbe565d7d757bd1cdee3bb7d7b42bf1430efffebc78");  // 380000
        ...
        assert(consensus.hashGenesisBlock == uint256S("0x9bde1219ab2a738dec00fcbe565d7d757bd1cdee3bb7d7b42bf1430efffebc78"));
        assert(genesis.hashMerkleRoot == uint256S("0x981da5a60462ba61e6d88a1e8892ba6801f281f5bdf078d0f2eeeb92b9e47485"));
        ...
        checkpointData = {
            {
                {     0, uint256S("0x9bde1219ab2a738dec00fcbe565d7d757bd1cdee3bb7d7b42bf1430efffebc78")},
...
public:
    CTestNetParams() {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xe3436937409c4765790de8a408bd72acf52286dc48cf2103ca8c7592539cd908"));
        assert(genesis.hashMerkleRoot == uint256S("0x2d1001602de4b85941bec5b7df60affbbdcee481222a9b108acbeb6b262b2920"));
